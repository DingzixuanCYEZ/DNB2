...
const MODE_REALMS: Record<PlayMode, string[]> = {
    ...
    technique: ['', '素人', '童生', '秀才', '贡生', '举人', '贡士', '进士', '翰林', '大学士', '大儒', '鸿儒', '文宗', '大贤', '半圣', '亚圣', '至圣'],
    score: ['', '光子', '原子', '星砾', '流星', '彗星', '卫星', '行星', '恒星', '星团', '星云', '星河', '星系', '星系群', '星系团', '星系长城', '宇宙']
};
...
const RANK_SYSTEM = [
  ...
  { name: '铂金卿相', color: '#00dddd' }, // 蓝绿：位极人臣的显贵 120-139
          ...
          <div className="modal" onClick={e => e.stopPropagation()} style={{ 
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16, flexShrink: 0 }}>
              ...
              <div style={{display: 'flex', gap: 12, alignItems: 'center'}}>
                  {/* 【新增】：切换视图按钮 */}
                  <button 
                    onClick={() => setShowRankMap(!showRankMap)}
                    style={{
                        background: showRankMap ? '#e0f2fe' : 'transparent',
                        color: showRankMap ? '#0284c7' : '#64748b',
                        border: showRankMap ? '1px solid #bae6fd' : '1px solid #e2e8f0',
                        borderRadius: 8,
                        padding: '4px 8px',
                        fontSize: '0.8rem',
                        fontWeight: 600,
                  ...
                  >
                      {showRankMap ? <Layers size={14}/> : <Trophy size={14}/>}
                      {showRankMap ? '查看记录' : '段位图谱'}
                  </button>
